package org.datap_rs.jdbc.internal.http;
 ...
 *
 * <p>One instance per {@link org.datap_rs.jdbc.DataPressConnection}.
 */
public final class HttpApi implements AutoCloseable {
  ...
  /**
   * Readiness probe used by {@link org.datap_rs.jdbc.DataPressConnection#isValid(int)}: {@code GET
