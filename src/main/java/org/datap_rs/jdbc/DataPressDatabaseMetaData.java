...
import org.datap_rs.jdbc.internal.meta.LikePattern;
import org.datap_rs.jdbc.internal.meta.SyntheticResultSet;
import org.datap_rs.jdbc.internal.util.VersionInfo;
  ...
  public ResultSet getColumns(
    ...
    for (String table : names) {
      ...
      for (JsonNode column : columns) {
        ...
        ColumnMeta meta =
            org.datap_rs.jdbc.internal.arrow.TypeMapping.ofServerType(
